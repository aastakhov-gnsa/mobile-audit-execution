 ...
 */
export const SignaturePartner = forwardRef<SignatureViewRef, SignaturePartnerProps>(({
    initialBase64 = '',
    email,
    onEmailChange,
    sendToMe,
    ...
    return <>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.copy}>
            ...
            <Switch style={styles.switch} value={sendToMe} onValueChange={onSendToMeChange} />
          </View>
        </View>
    </>
})

...
import { NavigationParams, SignatureRouteParams } from '../../interfaces/navigation';
...
export function SignatureScreen() {
    ...
    const handleOk = async (base64?: string) => {
        ...
        const readPermissions = await fRequestAndroidPermissionRead();
            ...
            navigation.navigate(ScreenNames .SvSRPreview, {file: `file://${path}`, surveyId: data.id, data, filters });
            }
        const formData = []
        formData.push({
            name: 'signBase64',
    ...
    return <ScrollView scrollEnabled={scrollEnabled} style={styles.container}>
        ...
        <View style={styles.content}>
            ...
            <View style={styles.notice}>
                <Text style={styles.noticeText}>
                    By signing the Survey Status Report I acknowledge that I have received
                    the Survey Status Report and take notice of the results of today's audit
                </Text>
            ...
            <View style={styles.form}>
                ...
                <TextInput
                    mode="outlined"
                    placeholder="Enter e-mail or several, split by comma"
                    value={email}
        ...
        <View style={styles.actionsContainer}>
            ...
            <Button mode="contained" onPress={handleNext} loading={loading}>Save and Upload</Button>
            </View>
        </View>
    </ScrollView>
}
